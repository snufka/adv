...
<form method="POST" action="https://mariname86.activehosted.com/proc.php" id="_form_9_" class="_form _form_9 _inline-form  _dark" novalidate>
  ...
  <div class="_form-content">
    <div class="_form_element _x32910573 _full_width _clear" >
      <div class="_form-title">
        Let&#039;s Talk!
      </div>
    </div>
    <div class="_form_element _x54527394 _full_width _clear" >
    ...
    <div class="_form_element _x27211959 _full_width " >
    ...
    <div class="_form_element _x36758101 _full_width " >
      <label class="_form-label">
        Phone
      </label>
      <div class="_field-wrapper">
    ...
    <div class="_form_element _x80041623 _full_width " >
      <label class="_form-label">
        Email*
      </label>
      <div class="_field-wrapper">
    ...
    <div class="_form_element _field2 _full_width " >
      ...
      <div class="_field-wrapper">
        <select name="field[2]" required>
          ...
          <option value="in 3-6 weeks" >
            in 3-6 weeks
          </option>
          <option value="in 3 months or later" >
    ...
    <div class="_form_element _field3 _full_width " >
      ...
      <div class="_field-wrapper">
        <select name="field[3]" >
          ...
          <option value="1-10 worker" >
            1-10 worker
          </option>
          <option value="11-50 worker" >
            11-50 worker
          </option>
          <option value="51-500 worker" >
            51-500 worker
          </option>
          <option value="500+ worker" >
            500+ worker
          </option>
        </select>
      </div>
    ...
    <div class="_form_element _x68370907 _full_width " >
      <label class="_form-label">
...
window.cfields = {"2":"project_start","1":"project_budget","3":"company_size","4":"message"};
...
(function() {
  ...
  var form_submit = function(e) {
    ...
    if (validate_form()) {
      ...
      _load_script('https://mariname86.activehosted.com/proc.php?' + serialized + '&jsonp=true');
    }
    return false;
  };
